...
{#if counter === 0}
	<GradientButton
		...
		color="red">Want to delete your account?</GradientButton
	>
{:else}
	<p class="mt-2 mb-2 text-center text-sm text-red-600 dark:text-red-500">
		<span class="font-medium">Warning!</span> This action is permanent!
	</p>
